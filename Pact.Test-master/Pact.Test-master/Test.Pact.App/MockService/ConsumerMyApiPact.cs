...
namespace Test.Pact.App.MockService
{
    public class ConsumerMyApiPact
    {
        ...
        {
            PactBuilder = new PactBuilder(new PactConfig { PactDir = _fullPath.Substring(0, _fullPath.LastIndexOf('\\'))+@"\Pact", LogDir = _fullPath.Substring(0, _fullPath.LastIndexOf('\\')) + @"\Pact" }); ;
